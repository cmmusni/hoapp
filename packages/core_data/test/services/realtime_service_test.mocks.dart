...
// in core_data/test/services/realtime_service_test.dart.
...
import 'package:realtime_client/src/message.dart' as _i11;
  ...
  _i6.Future<_i2.ChannelResponse> track(
    ...
    Map<String, dynamic>? opts = const {},
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i6.Future<_i2.ChannelResponse>.value(_i2.ChannelResponse.ok),
...
class MockRealtimeClient extends _i1.Mock implements _i2.RealtimeClient {
  ...
  void log([
    ...
    String? msg,
    dynamic data,
    _i10.Level? level = _i10.Level.FINEST,
  ]) =>
      super.noSuchMethod(
        Invocation.method(
          #log,
  ...
  @override
  String? push(_i11.Message? message) => (super.noSuchMethod(Invocation.method(
        #push,
        [message],
      )) as String?);
