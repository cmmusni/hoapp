...
class HelpTopic {
  ...
  final String answer;
  final String? route; // optional GoRouter path suffix e.g. '/announcements'
...
const List<HelpTopic> helpTopics = [
  ...
  HelpTopic(
    ...
    answer: '1. Tap **Announcements** in the sidebar.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Go to the **Violations** page from the sidebar.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Open the **Billing & Payments** page.\n'
        ...
        '3. To pay, click **Pay** on an invoice.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Go to **Billing & Payments**.\n'
        ...
        '3. Click the **+** button to create a new invoice.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Navigate to the **Expense Tracker** page.\n'
        ...
        '3. Click **+** to log a new expense with amount, category, and receipt.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Go to **Pool Access** in the sidebar.\n'
        '2. Click **Request Access** to submit a new pool access request.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Open **Registered Swimmers** from the sidebar.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Go to the **Households** page.\n'
        ...
        '3. Click a unit to see/edit household details and members.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Navigate to **Manage Users**.\n'
        ...
        '3. Click a user to edit their role (admin, staff, resident, guard, maintenance).\n'
  ...
  HelpTopic(
    ...
    answer: '1. Open the **Security Pass** page.\n'
        '2. Click **Create Pass** to generate a new visitor/delivery pass.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Go to the **Feedback** page.\n'
        '2. Click **+** to submit new feedback.\n'
  ...
  HelpTopic(
    ...
    answer: '1. Click the user icon on the top-right of the app bar.\n'
        '2. Select **Notifications** from the dropdown.\n'
        '3. You\'ll see all your activity notifications.\n'
        '4. Notifications are also shown as red badges on sidebar items.',
    route: '/notifications',
  ),
  ...
  HelpTopic(
    ...
    answer: '1. Click the user icon in the top-right corner.\n'
...
/// [userRole] – lowercase role name (e.g. 'admin', 'resident').
/// [maxResults] – max topics to return (defaults to 3).
List<HelpTopic> searchTopics(String query,
  ...
  for (final topic in helpTopics) {
    // Filter by role if topic is role-restricted
...
/// Returns suggested quick-action topics based on the current route.
List<HelpTopic> suggestionsForRoute(String currentPath, {String? userRole}) {
  ...
  for (final topic in helpTopics) {
    ...
    if (topic.route != null && currentPath.contains(topic.route!)) {
      suggestions.add(topic);
    }
  }

  // If no route-specific suggestions, return general ones
  if (suggestions.isEmpty) {
    return helpTopics
        .where((t) {
          ...
          return t.route == null; // general topics
        })
        .take(3)
        .toList();
  }
