-- Delete all references to mariellecasbadillo30@gmail.com
-- Run this in Supabase Studio SQL Editor

DO $$
DECLARE
    v_user_id uuid;
    v_email text := 'mariellecasbadillo30@gmail.com';
BEGIN
    -- Get the user ID
    ...
    ELSE
        ...
        -- Delete from auth.users (this will cascade to identities)
...
WHERE u.email = 'mariellecasbadillo30@gmail.com'
