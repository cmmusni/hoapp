-- SECURITY DEFINER function to check if a unit already has a pool registration
-- with swimmers. Bypasses RLS so any resident in the unit can see the lock status.
